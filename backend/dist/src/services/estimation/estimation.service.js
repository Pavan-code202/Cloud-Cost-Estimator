import { normalizeWorkload } from '../workload/workload.service.js';
import { filterCompatible } from '../configuration/configuration.service.js';
function amount(c, category) {
 ...
 */
function extractWorkloadProfile(workload) {
    return {
